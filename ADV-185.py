...
btn=Button(root, text="Apply MD5",command=md5,relief=FLAT, bg="orange2",fg="white")
btn.place(relx=0.3,rely=0.5, anchor=CENTER)

btn1=Button(root, text="Apply SHA256",command=SHA256,relief=FLAT,bg="orange2",fg="white")
